...
class BaseTabBarController: UITabBarController {
    ...
    private func addChildViewControllers() {
        setChildViewController(TokensViewController(), title: "首页", imageName: "shouye")
        setChildViewController(GameViewCtr(), title: "社群", imageName: "fenlei")
         setChildViewController(RstandViewCtr(), title: "Game", imageName: "fenlei")
        setChildViewController(MyViewCtr(), title: "我的", imageName: "wode")
    }
    /// 初始化子控制器
